...
def test_optimizer_view_renders_with_streamlit_testing() -> None:
    ...
    assert any(subheader.value == "Simulation Weight Table" for subheader in app.subheader)
...
def test_optimizer_lifecycle_holds_render_with_residual_cash() -> None:
    ...
    assert any("Open replay lifecycle output" in info.value for info in app.info)
