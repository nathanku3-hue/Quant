...
Next action: complete local C1 bank (21-path model on `b7a24d3`), then push for hosted Ubuntu/Windows + independent A/B/C; do not open G08 session until one-shot Attempt-1 authorization is remotely retained.
...
- [x] Fast-forward/merge main via PR #4 @ `2653eb1`.
- [x] Open E0B-DV1 repair (active addendum above).
