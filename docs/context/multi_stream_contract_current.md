...
- immutable experiment/evidence/seal identity;
- Parent/Child single-mutation relationship;
- accounting reconciliation tolerance.
...
- external custody work rewrites the immutable local candidates.
