# Phase 65 G7.1F Compatibility Selector Alias

This file intentionally mirrors the G7.1F CFTC TFF tiny fixture context packet for humans looking for the `0f` suffix. The selected context-builder alias is `docs/handover/phase65_g71-000f_handover.md`.
