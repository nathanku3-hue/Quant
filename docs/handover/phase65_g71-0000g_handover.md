# Phase 65 G7.1G Selector Alias - FRED / Ken French Tiny Fixture Proof

This selector alias intentionally mirrors `docs/handover/phase65_g71g_fred_ken_french_tiny_fixture_handover.md` so `scripts/build_context_packet.py` selects G7.1G as the latest same-phase G7.1 alpha substep.
