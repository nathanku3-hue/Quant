...
Selector note: this filename intentionally sorts before older G7.1 selector aliases under the current context builder. The canonical handover is `docs/handover/phase65_g71e_finra_tiny_fixture_handover.md`. This alias is not G7.2 and does not authorize state-machine work.
