...
Only Slices 0–1 are implementation-authorized after audit. Later boundaries remain evidence-gated so delivery does not return to open-ended architecture discovery.
