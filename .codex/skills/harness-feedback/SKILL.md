...
This repo-local adapter writes feedback into Quant's existing SAW/lesson loop. The generic meta-harness template is installed under `.meta-harness/templates/skills/harness-feedback.md` for reference.
